// Minimal dependency-free DSP used by the Transcendence build-time analyser.
// Everything here is deterministic: the same input file always yields the same
// analysis payload, which is what lets the runtime reconstruct world state from
// audio.currentTime alone.
...
/** Normalised autocorrelation pitch estimate. Returns { f0, confidence }. */
export function estimatePitch(samples, start, size, sampleRate, minHz, maxHz) {
