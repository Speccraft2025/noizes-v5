...
var _a;
var buffer = typeof process === "object" && ((_a = process.versions) == null ? void 0 : _a.node) !== void 0;
...
async function stringifyAsync(value, reducers) {
  ...
  for (let i = 0; i < stringified.length; i += 1) {
    let value2 = stringified[i];
    if (typeof value2 !== "string") {
      await value2;
      value2 = stringified[i];
      if (i === 0 && value2 < 0) {
        return `${value2}`;
      }
    }
    ...
    if (is_primitive(thing)) {
      ...
      switch (type) {
        ...
        case "Map":
          str = '["Map"';
          for (const [key, value2] of thing) {
            keys.push(`.get(${is_primitive(key) ? stringify_primitive2(key) : "..."})`);
