...
<div class="space-y-5">
  ...
  <div>
    <label class="label-dark" for="edition_name">Public edition name *<HelpTip field="edition_name" /></label>
    <input id="edition_name" class="input-dark" type="text" bind:value={$edition.edition_name} placeholder="e.g. Inaugural Pressing" />
  </div>

  <div>
    <label class="label-dark" for="edition_description">Edition description<HelpTip field="edition_description" /></label>
  ...
  <div>
    <label class="label-dark" for="edition_size">Fixed supply *<HelpTip field="edition_size" /></label>
  ...
  <div class="grid grid-cols-3 gap-3">
    <div class="col-span-2">
      <label class="label-dark" for="price">Price *<HelpTip field="price" /></label>
      <input id="price" class="input-dark" type="number" min="0.01" step="0.01" bind:value={$edition.price} placeholder="0.00" />
    </div>
    <div>
      <label class="label-dark" for="currency">Currency<HelpTip field="currency" /></label>
  ...
  <div class="flex items-center gap-3">
    ...
    <label for="transferable" class="text-sm font-semibold text-white cursor-pointer">
      Transferable ownership<HelpTip field="transferable" />
    </label>
  </div>
</div>
