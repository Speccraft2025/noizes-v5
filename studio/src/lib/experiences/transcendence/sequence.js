...
export const ITINERARY = [
  ...
  { id: 'approach', phase: 'flight', shot: 'approach', at: 0.558, snap: 0.05, world: { air: 0.9, relief: 1.04, atmosphere: 0.9, ahead: 0.4 } },
  ...
  { id: 'high', phase: 'voice', shot: 'highTraverse', at: 0.760, snap: 0.06, voice: true, world: { air: 0.95, relief: 1.1, atmosphere: 0.85, ahead: 0.35 } },
...
const SCENES = {
  ...
  approach: 'The flight drops toward the floor of the world, close enough that individual ridges resolve.',
  trough: 'Ground level, between two harmonic walls, reading a line off the flank of the ridge that carries it.',
  rise: 'The view climbs away from the floor and the whole shape of the passage becomes visible again.',
  high: 'A high traverse across the frequency axis while the melodic source is still sounding.',
...
const TITLES = {
  ...
  open: 'The country opens', approach: 'Approach', trough: 'In the trough',
  rise: 'Rise', high: 'High traverse', ascend: 'The climb', apex: 'Apex',
