...
export const ITINERARY = [
  ...
  { id: 'descent', phase: 'descent', shot: 'descent', at: 0.032, snap: 0.03, world: { air: 0.55, relief: 1, atmosphere: 1.05, ahead: 0.62 } },
  { id: 'ranges', phase: 'flight', shot: 'ranges', at: 0.058, snap: 0.04, attention: true, world: { air: 0.75, relief: 1, atmosphere: 0.95, ahead: 0.55 } },
  { id: 'expanse', phase: 'flight', shot: 'expanse', at: 0.110, snap: 0.05, world: { air: 0.85, relief: 1.04, atmosphere: 0.9, ahead: 0.5 } },
  { id: 'voice', phase: 'voice', shot: 'vocalRidge', at: 0.140, snap: 0.07, voice: true, world: { air: 0.9, relief: 1.06, atmosphere: 0.85, ahead: 0.45 } },
  { id: 'breath', phase: 'flight', shot: 'erasure', at: 0.220, snap: 0.05, world: { air: 0.8, relief: 1, atmosphere: 1.05, ahead: 0.5 } },
  { id: 'second', phase: 'voice', shot: 'traverse', at: 0.240, snap: 0.06, voice: true, world: { air: 0.9, relief: 1.08, atmosphere: 0.85, ahead: 0.42 } },
  { id: 'summit', phase: 'summit', shot: 'summit', at: 0.290, snap: 0.05, world: { air: 1, relief: 1.16, atmosphere: 0.78, ahead: 0.38 } },
  { id: 'sustain', phase: 'flight', shot: 'sustain', at: 0.340, snap: 0.05, world: { air: 0.95, relief: 1.06, atmosphere: 0.88, ahead: 0.42 } },
  { id: 'open', phase: 'flight', shot: 'sustain', at: 0.390, snap: 0.05, world: { air: 0.68, relief: 0.94, atmosphere: 1.2, ahead: 0.5 } },
  { id: 'approach', phase: 'flight', shot: 'valleyEnter', at: 0.440, snap: 0.05, world: { air: 0.9, relief: 1.04, atmosphere: 0.9, ahead: 0.4 } },
  { id: 'trough', phase: 'voice', shot: 'trough', at: 0.500, snap: 0.06, voice: true, world: { air: 0.95, relief: 1.06, atmosphere: 0.85, ahead: 0.35 } },
  { id: 'closePass', phase: 'flight', shot: 'closePass', at: 0.560, snap: 0.04, world: { air: 0.95, relief: 1.08, atmosphere: 0.82, ahead: 0.32 } },
  { id: 'rise', phase: 'flight', shot: 'rise', at: 0.610, snap: 0.05, world: { air: 0.85, relief: 1, atmosphere: 0.95, ahead: 0.42 } },
  { id: 'high', phase: 'voice', shot: 'crest', at: 0.650, snap: 0.06, voice: true, world: { air: 0.90, relief: 1.1, atmosphere: 0.88, ahead: 0.38 } },
  { id: 'corridor', phase: 'flight', shot: 'corridor', at: 0.700, snap: 0.05, world: { air: 0.92, relief: 1.08, atmosphere: 0.84, ahead: 0.34 } },
  { id: 'highTraverse', phase: 'flight', shot: 'highTraverse', at: 0.750, snap: 0.05, world: { air: 0.88, relief: 1.12, atmosphere: 0.86, ahead: 0.40 } },
  { id: 'reveal', phase: 'flight', shot: 'reveal', at: 0.800, snap: 0.04, world: { air: 0.85, relief: 1.06, atmosphere: 0.92, ahead: 0.42 } },
  { id: 'ascend', phase: 'convergence', shot: 'ascend', at: 0.860, snap: 0.04, world: { air: 1, relief: 1.2, atmosphere: 0.72, ahead: 0.28 } },
  { id: 'apex', phase: 'apex', shot: 'apex', at: 0.900, snap: 0.04, apex: true, world: { air: 0.95, relief: 1.24, atmosphere: 0.68, ahead: 0.2 } },
  { id: 'return', phase: 'atlas', shot: 'atlasReturn', at: 0.930, snap: 0.02, world: { air: 0.7, relief: 1.1, atmosphere: 0.95, ahead: 0.32 } },
  { id: 'condense', phase: 'condense', shot: 'condense', at: 0.960, snap: 0.02, world: { air: 0.4, relief: 0.9, atmosphere: 1.15, ahead: 0.4 } },
  { id: 'residue', phase: 'residue', shot: 'specimen', at: 0.978, snap: 0, world: { air: 0.28, relief: 0.9, atmosphere: 1, ahead: 0.4 } },
...
const SCENES = {
  ...
  corridor: 'The flight drops into a narrow passage between two mountain flanks. The terrain fills the peripheral view.',
  highTraverse: 'A traverse high across the ranges, the whole shape of the recording visible ahead as geological country.',
...
const TITLES = {
  ...
  corridor: 'The corridor', highTraverse: 'High traverse',
